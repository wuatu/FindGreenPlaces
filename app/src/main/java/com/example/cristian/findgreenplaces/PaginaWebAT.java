...
public class PaginaWebAT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagina_web_at);
    ...
    public void aceptar(){
        buttonAceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                builder = new AlertDialog.Builder(PaginaWebAT.this,AlertDialog.THEME_HOLO_LIGHT);
                builder.setTitle("Información")
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(PaginaWebAT.this,"Datos enviados correctamente!",Toast.LENGTH_SHORT).show();
                                finish();
                            }
                        })
